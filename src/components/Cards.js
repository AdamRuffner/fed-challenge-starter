  ...
  return (
    <div className="card-container">
      ...
      <div className="card">
        <div className="img-header">
          <img
            src="https://ucff9a44fbcc9381e87b04bd331c.previews.dropboxusercontent.com/p/thumb/ABEtWsLr6ocbzexG4cBLnnN_yJ9-Ygkq9lDnslE0hm9hejHc7du46BE7Ms2sNYsk5-8COtWJeQ7j3guJSf2jznj8R2qMXDXLb57LmmNuIKz3WJcuF8kF4bGEtalvQOoxVr5lC554vKFbf0WCYhweo5ihWfg33nPmzHuGpVSf0Yh-P2J8-R1IFJDz0PvZ7cbI-iRITVuhZS6vSSF5YXH8fMi3VRrL12GqqI-D-l6HZZNZWxasdwIdnMgw0zDytIiBQlrTkoXlUB0CRSGPjrP_whdHKDpc2JWRs4vnIkvVwrmlaSDgUeqBgsMpknAIqiAxsVHsNV7-Kdx0AciViy4tON3pP6LdT3zat1Fj9ui5qV9R7g/p.jpeg?fv_content=true&size_mode=5"
            alt="HIIT Series"
          />
        </div>
        <div className="info">
          <h1>Full-Body HIIT Series</h1>
          <img
            src="https://uc15d678cc458ecad5c415b52b7e.previews.dropboxusercontent.com/p/thumb/ABGnfC4PM6FofqisWaXJ8in6iUcNdJ-S473K5mZ7XaOlXW7UgbWnQiKxhpgHZJ_w1ThfRjPseSZ_4VwDujHTFq_yh7fTJ8xGQfPLIhw37Lji1F8DjMCgZDTvfKFFYkmgnh8Ojd-N2s70sLCwFEasxpK_ofkzxAeMM-Exsxh6c827y0ztTw0toUNR7VrjyFBwcGQ_y5HeOUQo4sx2D30L1OlgbshDjhtywqk1xfDtQ_r9oq90jAJBunethBvP2T8YV3uddM8AKKyJBkWmFbw_8_wZALwx5zQeWl-n437c6X1Wy3kdW7frbe-L0T0mV-7ulmkwAQu8BQSC6_MV1jI4aGDAgjsGl4X_MfIs8g8DYmqxrQ/p.jpeg?fv_content=true&size_mode=5"
            alt="instrucor"
          />
        </div>
        <button id="toggleButton">
      ...
      <div className="card">
        <div className="img-header">
          <img
            src="https://uc8194e10c1a52cd8b2e4578aa0c.previews.dropboxusercontent.com/p/thumb/ABHRE6TnIw9Wfc723hPV38X0c08RLST9u6799SBv84qRiO1Mf0EIVSK-fcYydQC0x4kJf5SHtvwbNuM4ENUJ3PbRI8OWBVv0GNHzNseFpvh-VYtGqAKL2dVxezsapMYmANEASqjyR6xKICWaJM1mptui8dLOL8jgshzpY8Zrz462K1pPk97v0u7xKeZsU63qc52ylMYN1hr8sd_6xcWtGUrDoNT5Zb9aNCzRvTdYe1GmrYESGq9ZXbH302HuJK4MYwktXetuKY6bGHJw-BpYQOTLdfiMUIvPHEjQWdiDalzV_tbEcs_CTYDfB8JXh8dkx-CyMC-Hy-vYjP_WnqQD8Mk_imOf8ycoTe6H3B6Rvn6P8g/p.jpeg?fv_content=true&size_mode=5"
            alt="kafue river"
          />
        </div>
        <div className="info">
          <h1>Kafue River, Zambia - Power Stroke Pyramid</h1>
          <img
            src="https://ucc63ec9d97f98dafcb3c3c62303.previews.dropboxusercontent.com/p/thumb/ABHhwCIbwQVTTz-HC9lqlI37BfnTkEAR4I-m8zNIUmtqJFzwV5X1zR5i54L5sCEwnL9BE7s7IdlmZipUSYLQY75i0zlTauPdK4AWsrDM0464S2WDFw5-8efojUj5Om8f1Xq3v1ZnJDjVu0l6_s7TOTrRnYhQbwwGnII5XXtNQThel1lMi_dV4P0IXVKmguZtP07T_YbrQov_YZAWS_PqkqqtkdJL79PJkyfhdGS_klj8crUPhulQomDTg9rJRn289-CbjF-sY4fUa9TUa04dbCWzQS8m_CbYFZQTBjns14bgxYb1q9UutgkSJ--Y5uHRBwEJh22B3IJij9HU8MsJTzcKuWDAIEyWHxOeAJ7inogAsw/p.jpeg?fv_content=true&size_mode=5"
            alt="instrucor"
          />
        </div>
        <p>
          <BiStopwatch /> 22:22 <FaRunning /> 4,660 M
        </p>
        <button id="toggleButton">
          {active === true ? "VIEW DETAILS" : ""}
        </button>
